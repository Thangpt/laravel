                ...
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 clearpaddingr">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
                        <ol class="breadcrumb">
                            ...
                            <li><a style="text-decoration:none" href="{{url('user/order')}}">All Orders</a></li>
                            <li>Details</li>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        @if($order->is_send && !$order->is_received)
                                            <button style="float:right" class="btn btn-primary"><a
                                                    style="color:white;text-decoration:none;"
                                                    href="{{url('user/order/received/'.$order->order_id)}}">Received</a>
                                            </button>
                                        @endif
